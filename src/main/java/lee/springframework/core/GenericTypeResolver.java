 ...
 * @file: GenericTypeResolver.java project: lee-spirng
 * @creator: liyong18
 * @date: 2018/7/31
 */
...
public class GenericTypeResolver {
  ...
  /**
   * TypeVariableMapVariableResolver = TypeVariableMap  +VariableResolver  = 测落+接口
   */
